...
#    Although every effort has been made to ensure accuracy, we (Daimler AG, MPI
#    Informatics, TU Darmstadt) do not accept any responsibility for errors or
#    omissions.
# 2. That you include a reference to the Cityscapes Dataset in any work that
...
# 5. That all rights not expressly granted to you are reserved by us (Daimler
...
# whatever you like.
# Make sure to provide your results using the original IDs and not the training
# IDs.
...
def print_label(label):
    print((
        "    {:>21} | {:>3} | {:>7} | {:>14} | {:>10} | {:>12} | {:>12}".format(
            label.name, label.id, label.trainId, label.category,
