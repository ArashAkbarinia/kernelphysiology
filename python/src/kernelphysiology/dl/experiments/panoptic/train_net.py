...
from kernelphysiology.dl.pytorch.datasets.detecron_dbs import \
    register_all_pascal_voc_org
from kernelphysiology.dl.experiments.panoptic.dataset_mapper import \
    DatasetMapper
...
def setup(args):
    ...
    """
    from kernelphysiology.dl.experiments.panoptic.defaults import _C
    cfg = _C.clone()
