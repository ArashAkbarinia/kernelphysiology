function heatmap = graphical_deconvolution(net, im, im_, dispargs, varargin)
...
%       since this method usually gives the best results.disprgs
%
...
if isa(net, 'DDagNN') || isa(net, 'dagnn.DagNN')
  ...
  heatmap = simplenn_graphical_deconvolution(net, im, im_, dispargs, varargin{:});
end
